...
beginning_rep1 <- min(cages$DateTime)
baseline_rep1 <- interval(beginning, ymd_hms("2022-10-06 11:59:59 EST"))
day1_rep1 <- interval(ymd_hms("2022-10-06 11:59:59 EST"), ymd_hms("2022-10-06 11:59:59 EST") + days(1))
day2_rep1 <- interval(ymd_hms("2022-10-06 11:59:59 EST") + days(1),ymd_hms("2022-10-06 11:59:59 EST") + days(2))
day3_rep1 <- interval(ymd_hms("2022-10-06 11:59:59 EST") + days(2),ymd_hms("2022-10-06 11:59:59 EST") + days(3))
```
...
coeff <- 0
temperatures <- ggplot(data = mouse_metadata[mouse_metadata$water == "yes",],
