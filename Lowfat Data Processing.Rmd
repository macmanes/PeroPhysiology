...
test_day1_temps <- read_csv("C:/Users/mdm2000/OneDrive - USNH/PeroPhysiology/test_day1_temps.csv", 
...
ldr2a <- bring_in_data("lowfat_dehydrated_41to66_rep2.csv")
...
ldr2b <- bring_in_data("lowfat_dehydrated_0to10_rep2.csv")
...
ldr2 <- bring_in_data("lowfat_dehydrated_0to3_rep2.csv")
